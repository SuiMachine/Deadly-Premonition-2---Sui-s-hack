...
namespace SuisHack
{
	public class ExposedSettings
	{
		...
		private void RegisterInputSettings()
		{
			...
			Input_Digital_A_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.A_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_B_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.B_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_X_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.X_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Y_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Y_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_LB.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.LB] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_RB.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.RB] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Back_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Back_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Start_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Start_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_L_Stick_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.L_Stick_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_R_Stick_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.R_Stick_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Up_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Up_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Right_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Right_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Down_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Down_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_Left_Button.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.Left_Button] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_LT.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.LT] = new KeySteamDigitalAction(newValue, false); };
			...
			Input_Digital_RT.OnValueChanged += (KeyCode oldValue, KeyCode newValue) => { GlobalInputHookHandler.Instance.DigitalInputToInput[SteamInputHook.SteamInputDigital.RT] = new KeySteamDigitalAction(newValue, false); };
